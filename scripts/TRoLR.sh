...
#
# Usage: TRoLR.sh <BAM_HP1> <BAM_HP2> <KARYOTYPE: XX|XY> <REF_FA> [OUTPUT_DIR]
#
set -euo pipefail
...
STRCHIVE_INFO=/n/users/sgibson/Projects/TANDEM_REPEATS/MiniSTR/ASM/reference_data/STRchive-disease-loci-v2.4.3.hg38.CE2vK2zA.tsv
